            ...
            for client, address in self.client_socket_list:
                try:
                    ...
                    if recv_msg:
                        ...
                        # str_recv_msg = str(binascii.hexlify(recv_msg))

                        # str_recv_msg = str(recv_msg)
                        # print(str_recv_msg)
                        #
                        # recv_msg = recv_msg.replace("b", '', 1)  # 去除第一个字母b
                        # recv_msg = recv_msg.replace("'", '')  # 去除单引号

                        # print(type(str_recv_msg))
